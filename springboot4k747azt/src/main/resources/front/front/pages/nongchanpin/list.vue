			...
			<view :style='{"minHeight":"100vh","width":"100%","padding":"20rpx 20rpx 240rpx","position":"relative","background":"#DCF7FF","height":"auto"}'>
				<view class="cu-bar bg-white search" :style='{"width":"100%","padding":"20rpx 0 0","background":"none","display":"flex","height":"auto"}'>
					<view :style='{"margin":"0 12rpx 0 0","flex":"1","position":"relative"}' class="search-form round">
						...
						<input :style='{"border":"2rpx solid rgb(55, 232, 220)","padding":"12rpx 20rpx 12rpx 80rpx","color":"#333","borderRadius":"10rpx","background":"#fff","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.chanpinmingcheng" type="text" placeholder="产品名称" ></input>
					</view>
				...
				<view :style='{"padding":"20rpx","margin":"20rpx 0","borderRadius":"20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%"}'>
					<view @click="sortClick('price')" :style='{"border":"2rpx solid rgb(55, 232, 220)","padding":"0 12rpx","margin":"0 8rpx 0 0","outline":"0","borderRadius":"8rpx","background":"#BBFFFA","display":"flex"}'>
						<text :style='{"color":"#37E8DC","lineHeight":"48rpx","fontSize":"24rpx"}'>价格</text>
						<text v-if="listSort!='price'" class="icon iconfont icon-xiaoliang17" :style='{"margin":"0 0 0 8rpx","lineHeight":"48rpx","fontSize":"24rpx","color":"#37E8DC"}'></text>
						<text v-else-if="listSort=='price'&&listOrder=='asc'" class="icon iconfont icon-xiaoliang17" :style='{"margin":"0 0 0 8rpx","lineHeight":"48rpx","fontSize":"24rpx","color":"#37E8DC"}'></text>
						<text v-else-if="listSort=='price'&&listOrder=='desc'" class="icon iconfont icon-xiaoliang17" :style='{"margin":"0 0 0 8rpx","lineHeight":"48rpx","fontSize":"24rpx","color":"#37E8DC"}'></text>
					</view>
				...
				<view :style='{"width":"100%","background":"none","height":"auto"}'>
					<scroll-view scroll-x="true" class="category-one" :style='{"width":"100%","whiteSpace":"nowrap","background":"none","display":"flex","height":"auto"}'>
						<view :class='categoryName === item.chanpinleixing ? "active" : ""' class="tab" v-for="(item,index) in categoryList" :key="index" @tap="categoryClick(item.chanpinleixing)">{{item.chanpinleixing}}</view>
					</scroll-view>
					<!-- 样式1 -->
					<view class="uni-product-list" :style='{"padding":"40rpx 0 0","alignItems":"flex-start","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
						<view @tap="onDetailTap(product)" class="uni-product" :style='{"padding":"0 0 20rpx","margin":"0 0 40rpx","backgroundColor":"#fff","borderRadius":"20rpx","flexWrap":"wrap","display":"flex","width":"48%","height":"auto"}' v-for="(product,index) in list" :key="index">
							...
							<view class="uni-product-title" :style='{"padding":"4rpx 20rpx","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"1.4","fontSize":"28rpx","textOverflow":"ellipsis"}'>{{product.chanpinleixing}}</view>
							...
							<view class="uni-product-price" :style='{"padding":"4rpx 20rpx","color":"red","textAlign":"right","width":"100%","lineHeight":"1.2","fontSize":"28rpx","fontWeight":"700"}'>
							...
							<view :style='{"width":"100%","padding":"8rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
								<view :style='{"display":"flex"}' v-if="(userid && isAuth('nongchanpin','修改')) || (!userid && isAuthFront('nongchanpin','修改'))" @tap.stop.proevent="onUpdate" :data-row="product">
								...
								<view :style='{"display":"flex"}' v-if="(userid && isAuth('nongchanpin','删除')) || (!userid && isAuthFront('nongchanpin','删除'))" @tap.stop.proevent="onDelete" :data-row="product">
							...
							<!-- #ifndef MP-WEIXIN -->
							<view :style='{"width":"100%","padding":"8rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
								<view :style='{"display":"flex"}' v-if="(userid && isAuth('nongchanpin','修改')) || (!userid && isAuthFront('nongchanpin','修改'))" @tap.stop.proevent="onUpdateTap(product)">
									<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#666","display":"inline-block"}' class="cuIcon-edit"></text>
									<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#666","display":"inline-block"}'>修改</text>
								</view>
								<view :style='{"display":"flex"}' v-if="(userid && isAuth('nongchanpin','删除')) || (!userid && isAuthFront('nongchanpin','删除'))" @tap.stop.proevent="onDeleteTap(product.id)">
									<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#666","display":"inline-block"}' class="cuIcon-delete"></text>
									<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#666","display":"inline-block"}'>删除</text>
								</view>
							</view>
				...
				<view class="screenBox" :class="screenBoxShow?'screenBoxActive':''">
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0","alignItems":"center","flexWrap":"wrap","justifyContent":"space-around","display":"flex"}'>
						<view :style='{"width":"100%","padding":"0 0 20rpx 20rpx","fontSize":"24rpx","color":"#858585"}'>简介</view>
						<input :style='{"border":"2rpx solid #CCCCCC","padding":"0 20rpx 0 20rpx","borderRadius":"4rpx","background":"#fff","width":"100%","lineHeight":"70rpx","height":"70rpx"}' placeholder="请输入简介" v-model="searchForm.jianjie">
					</view>
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0"}'>
						...
						<view :style='{"width":"100%","alignItems":"center","flexWrap":"wrap","justifyContent":"center","display":"flex"}'>
							<input :style='{"border":"2rpx solid #CCCCCC","borderRadius":"4rpx","textAlign":"center","background":"#fff","width":"45%","lineHeight":"70rpx","height":"70rpx"}' v-model="searchForm.pricestart" placeholder="请输入开始价格">
							<view :style='{"color":"#CCCCCC","padding":"0 10rpx","fontSize":"20rpx"}'>-</view>
							<input :style='{"border":"2rpx solid #CCCCCC","borderRadius":"4rpx","textAlign":"center","background":"#fff","width":"45%","lineHeight":"70rpx","height":"70rpx"}' v-model="searchForm.priceend" placeholder="请输入结束价格">
						</view>
					</view>
...
<script>
	export default {
		...
		async onShow() {
            ...
            let res = {};
            if(this.userid) {
                res = await this.$api.page('chanpinleixing', {page:1,limit:100});
            } else {
                res = await this.$api.list('chanpinleixing', {page:1,limit:100});
            }
			res.data.list.splice(0,0,{id:0,chanpinleixing:'全部'})
		...
		methods: {
			...
			async upCallback(mescroll) {
				...
				if(this.categoryName!='全部'){
					params.chanpinleixing = '%' + this.categoryName + '%'
				}
			...
			async search(){
				...
				if(this.categoryName!='全部'){
					searchForm.chanpinleixing = '%' + this.categoryName + '%'
				}
				if(this.searchForm.jianjie){
