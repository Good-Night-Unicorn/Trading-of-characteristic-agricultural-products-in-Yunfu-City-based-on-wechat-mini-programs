	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item v-else class="input" label="产地" prop="chandi" >
					<el-input v-model="ruleForm.chandi" placeholder="产地" readonly></el-input>
				</el-form-item>
				<el-form-item class="date" v-if="type!='info'" label="采摘日期" prop="caizhairiqi" >
					<el-date-picker
				...
				<el-form-item class="input" v-else-if="ruleForm.caizhairiqi" label="采摘日期" prop="caizhairiqi" >
...
<script>
	...
	export default {
		...
		created() {
			this.ruleForm.caizhairiqi = this.getCurDateTime()
		},
		methods: {
			// 下载
			download(file){
